...
class roomCalendarWidget extends StatefulWidget {
  ...
  const roomCalendarWidget(
      {Key? key,
      required this.lGetQueue,
      required this.headerText,
      required this.name})
      : super(key: key);

  @override
  State<roomCalendarWidget> createState() => _CalendarWidgetState();
}

class _CalendarWidgetState extends State<roomCalendarWidget> {
  @override

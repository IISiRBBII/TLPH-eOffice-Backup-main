...
class carCalendarWidget extends StatefulWidget {
  final List<queueModel> lGetQueue;
  final String headerText;

  const carCalendarWidget(
      {Key? key, required this.lGetQueue, required this.headerText})
      : super(key: key);

  @override
  State<carCalendarWidget> createState() => _CalendarWidgetState();
}

class _CalendarWidgetState extends State<carCalendarWidget> {
  @override
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Padding(
                        padding: EdgeInsets.only(top: 4, bottom: 4),
                        child: Text('ประเภทรถ : ${appointment.carType}'),
                      ),
                    ),
                    Container(
                      width: 140,
                      ...
                      child: Padding(
                        padding: EdgeInsets.only(top: 4, bottom: 4),
                        child: Text('ID รถ : ${appointment.unitId}'),
                      ),
                    ),
                    Container(
                      width: 140,
                      ...
                      child: Padding(
                        padding: EdgeInsets.only(top: 4, bottom: 4),
                        child: Text('รถ : ${appointment.unit}'),
                      ),
                    ),
                    Container(
                      width: 140,
  ...
  for (var qu in lGetQueue) {
    if (qu.type == 'car') {
      ...
      appointments.add(Appointment(
        ...
        unitId: qu.unitId,
        unit: qu.unit,
        boxColor: Colors.red, // เปลี่ยนสีตามต้องการ
      ));
    }
  }
